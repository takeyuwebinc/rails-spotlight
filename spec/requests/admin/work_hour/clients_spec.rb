...
RSpec.describe "Admin::WorkHour::Clients", type: :request do
  ...
  describe "GET /admin/work_hour/clients" do
    ...
    it "returns http success" do
      get admin_work_hour_clients_path
  ...
  describe "GET /admin/work_hour/clients/:id" do
    ...
    it "returns http success" do
      get admin_work_hour_client_path(client)
      expect(response).to have_http_status(:success)
    end
  ...
  describe "GET /admin/work_hour/clients/new" do
    it "returns http success" do
      get new_admin_work_hour_client_path
      expect(response).to have_http_status(:success)
    end
  end
  ...
  describe "POST /admin/work_hour/clients" do
    context "with valid params" do
      ...
      it "creates a new client" do
        expect {
          post admin_work_hour_clients_path, params: valid_params
    ...
    context "with invalid params" do
      ...
      it "does not create a client" do
        expect {
          post admin_work_hour_clients_path, params: invalid_params
  ...
  describe "GET /admin/work_hour/clients/:id/edit" do
    ...
    it "returns http success" do
      get edit_admin_work_hour_client_path(client)
      expect(response).to have_http_status(:success)
    end
  end
  ...
  describe "PATCH /admin/work_hour/clients/:id" do
    ...
    context "with valid params" do
      ...
      it "updates the client" do
        patch admin_work_hour_client_path(client), params: valid_params
        client.reload
    ...
    context "with invalid params" do
      ...
      it "returns unprocessable entity" do
        patch admin_work_hour_client_path(client), params: invalid_params
        expect(response).to have_http_status(:unprocessable_entity)
      end
    end
  end
  ...
  describe "DELETE /admin/work_hour/clients/:id" do
    ...
    it "deletes the client" do
      expect {
        delete admin_work_hour_client_path(client)
      }.to change(::WorkHour::Client, :count).by(-1)
    end
